...
book1.year = 1996;
console.log(
  `Book name: ${book1.name}, Author: ${book1.author}, Year: ${book1.year}`,
);
...
ebook1.format = "EPUB";
console.log(
  `E-Book title: ${ebook1.name}, Author: ${ebook1.author}, Format: ${ebook1.format}`,
);
...
console.log(
  `The oldest book is: ${oldestBook.name}, ${oldestBook.author}, ${oldestBook.year}`,
);
